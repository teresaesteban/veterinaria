                                ...
                                <tbody class="bg-gray-900">
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('usuarios.mascota', ['usuario' => auth()->user()->id]) }}" class="text-white hover:text-gray-400">{{ auth()->user()->name }}</a>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if (auth()->user()->mascota)
                                                <div class="text-sm text-white">Nombre: {{ auth()->user()->mascota->nombre }}</div>
                                                <div class="text-sm text-white">Tipo: {{ auth()->user()->mascota->tipo }}</div>
                                                <div class="text-sm text-white">Edad: {{ auth()->user()->mascota->edad }}</div>
                                            @else
                                                <div class="text-sm text-white">Sin mascota</div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('usuarios.agregar-mascota', ['usuario' => auth()->user()->id]) }}" class="text-white hover:text-gray-400">Añadir mascota</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
