                                ...
                                <div class="container px-5 pb-5">
                                    <div class="row gx-5 align-items-center">
                                        ...
                                        <div class="text-center text-xxl-start">
                                            ...
                                            <div class="fs-3 fw-light text-muted" id="Paracrearunanuevamascota"> Para
                                                crear una nueva mascota, haz clic en el botón azul. Para ver el
                                                historial de tu mascota, haz clic en tu perfil. </div>
                                            <h1 class="display-3 fw-bolder mb-5"id="Bienvenidoalhistorial"><span
                                                    class="text-white d-inline">Bienvenido al historial clínico de tu
                                                    mascota </span></h1>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card shadow">
                                                        <div class="card-header bg-gradient-primary-to-secondary py-3">
                                                            <h6 class="m-0 font-weight-bold text-white"
                                                                id="table-header">Tabla de usuarios y mascotas</h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <div class="mt-8">
                                                                    <h3
                                                                        class="text-lg font-semibold mb-4 text-black"id="tuusuario">
                                                                        {{ __('Tu Usuario') }}</h3>
                                                                    <table class="table table-striped table-bordered">
                                                                        <thead class="thead-dark">
                                                                            <tr
                                                                                class="bg-gradient-primary-to-secondary text-white">
                                                                                <th scope="col"id="nombre">
                                                                                    {{ __('Nombre') }}</th>
                                                                                <th scope="col"id="email">
                                                                                    {{ __('Email') }}</th>
                                                                                <th scope="col"id="mascota">
                                                                                    {{ __('Mascota') }}</th>
                                                                                <th scope="col"id="acciones">
                                                                                    {{ __('Acciones') }}</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <a href="{{ route('usuarios.mascota', ['usuario' => auth()->user()->id]) }}"
                                                                                        class="text-black hover:text-black-400 hover:underline thick-underline">{{ auth()->user()->name }}</a>
                                                                                    ...
                                                                                    @if (auth()->user()->mascota()->count() > 0)
                                                                                        ...
                                                                                        @foreach (auth()->user()->mascota as $mascota)
                                                                                            <div class="container mt-5">
                                                                                                ...
                                                                                                <div
                                                                                                    class="card bg-gradient-primary-to-secondary ">
                                                                                                    <div
                                                                                ...
                                                                                <td>
                                                                                    <a href="{{ route('usuarios.agregar-mascota', ['usuario' => auth()->user()->id]) }}"
                                                                                        class="btn bg-gradient-primary-to-secondary text-white"id="agregar-mascota">Añadir
                                                                                        mascota</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                ...
                                <div class="container px-5 pb-5">
                                    <div class=" align-items-center">
                                        ...
                                        <div class="text-center text-xxl-start">
                                            ...
                                            <div class="fs-3 fw-light text-muted"id="Paracrearunanuevamascota1"> Para
                                                crear una nueva mascota, haz clic en el botón verde. Para ver el
                                                historial de tu mascota, haz clic en tu perfil. </div>
                                            <h1 class="display-3 fw-bolder mb-5"id="Bienvenidoalhistorial1"><span
                                                    class="text-white d-inline">Bienvenido al buscador de usuarios
                                                </span></h1>
                                        </div>
                                            ...
                                            <div class="mb-8">
                                                <form action="{{ route('usuarios.search') }}" method="GET">
                                                    <div class="flex items-center border-b border-gray-600 py-2">
                                                        ...
                                                        <button type="submit"
                                                            class="ml-2 bg-gray-600 px-4 py-2 rounded-md hover:bg-gray-700"id="search1">Buscar</button>
                                                    </div>
                                                    <br>
                                                </form>
                                            </div>
                                            ...
                                            <div class="container">
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-10">
                                                        <div class="card shadow">
                                                            <div
                                                                class="card-header bg-gradient-primary-to-secondary py-3">
                                                                <h6 class="m-0 font-weight-bold text-white"
                                                                    id="table-header">Tabla de usuarios y mascotas</h6>
                                                            </div>
                                                            <div class="card-body">
                                                                            ...
                                                                            @foreach ($usuarios as $usuario)
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <a href="{{ route('usuarios.mascota', ['usuario' => $usuario->id]) }}"
                                                                                            class="text-black hover:text-black-400 hover:underline thick-underline">{{ $usuario->name }}</a>
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-6 py-4 whitespace-nowrap">
                                                                                        <div class="text-sm">
                                                                                    ...
                                                                                    <td
                                                                                        class="px-6 py-4 whitespace-nowrap">
                                                                                        @if ($usuario->mascota && $usuario->mascota->count() > 0)
                                                                                            <!-- Check if $usuario->mascotas is not null -->
                                                                                        ...
                                                                                        @else
                                                                                            <div
                                                                                                class="text-sm"id="Sinmascotas">
                                                                                                Sin mascotas</div>
                                                                                        @endif
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-6 py-4 whitespace-nowrap">
                                                                                        <a href="{{ route('usuarios.agregar-mascota', ['usuario' => $usuario->id]) }}"
                                                                                            class="btn bg-gradient-primary-to-secondary text-white"id="agregar-mascota">Añadir
                                                                                            mascota</a>
                                                                                    </td>
                                                                                </tr>
