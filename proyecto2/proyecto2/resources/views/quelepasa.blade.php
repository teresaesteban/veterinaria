<x-app-layout>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="fs-3 fw-light text-muted" id="subtitle">Podrás ver las preguntas frecuentes, aceder
                            a las últimas consultas o hacer tu própia pregunta</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-white d-inline" id="main-title">Solicita
                                información de nuestros especialistas </span></h1>
    ...
    <section class="content-section" id="preguntas-frecuentes">
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 ">
                <div class="col-lg-6 ">
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-4" href="#!"
                        onmouseover="showParagraph(this)">
                        <div class="caption ">
                            <div class="caption-content text-white">
                                <div class="h2" id="faq1-title">¿Por qué esterilizar a mi mascota antes de los dos
                                    años?</div>
                                <p class="mb-0" id="faq1-content">Si tenemos decidido no criar con ellas, los
                                    beneficios a largo plazo son muchos si decidimos esterilizarlas entre los siete
                                    meses y los dos años. Cuando hablamos de las hembras prevenimos los tumores de mama,
                                    las infecciones de matriz, los quistes ováricos y los embarazos psicológicos. Cuando
                                    hablamos de los machos prevenimos problemas de comportamiento (marcaje urinario,
                                    escapismo, agresividad), prostatitis y tumores testiculares. En Zarpa para la
                                    esterilización utilizamos técnicas de cirugía sin sangrado junto con protocolos para
                                    evitar el dolor y así asegurar una pronta recuperación.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-4" href="#!"
                        ...
                        <div class="caption">
                            <div class="caption-content text-white">
                                <div class="h2" id="faq2-title">¿Cómo evolucionan los problemas dentales de los
                                    perros/gatos?</div>
                                <p class="mb-0" id="faq2-content">Dientes sanos: son blancos y no presentan
                                    acumulaciones o decoloraciones, especialmente en los caninos e incisivos. Además,
                                    las encías son rosas y el aliento fresco. La placa dental: cuando los perros comen,
                                    los restos de alimento se acumulan en la línea de las encías y combinados con la
                                    saliva, forman una capa que se adhiere fuertemente en la base de los dientes.
                                    Conforme se va formando, la placa se introduce debajo de la encía provocando
                                    lesiones. El sarro y la gingivitis: el sarro resulta de la calcificación producida
                                    por la placa dental y la saliva. Al mismo tiempo, las bacterias del sarro rodean e
                                    invaden el diente y lo destruyen. Sin tratamiento, las inflamaciones provocan la
                                    pérdida de los dientes y la atrofia de los huesos. Enfermedad/inflamación
                                    progresiva: las bacterias pueden provocar gingivitis muy dolorosas. Una infección de
                                    la boca disminuye las defensas inmunitarias, y las bacterias pasan a la circulación
                                    sanguínea, pudiendo provocar infecciones a otros órganos.</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-4" href="#!"
                        ...
                        <div class="caption">
                            <div class="caption-content text-white">
                                ...
                                <p class="mb-0" id="faq3-content">Es muy importante combatirlos, pues son parásitos y
                                    transmiten enfermedades a las mascotas y a las personas. Nuestros consejos son: Usar
                                    productos de última generación, son los únicos realmente efectivos. Siempre es mejor
                                    usar tratamientos preventivos, pero si ya tenemos el problema, sobre todo en el caso
                                    de las pulgas, habrá que tratar tanto al animal como el ambiente.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-4" href="#!"
                        ...
                        <div class="caption">
                            <div class="caption-content text-white">
                                <div class="h2" id="faq4-title">¿Cuándo le pongo el collar antiparasitario a mi
                                    perro?</div>
                                <p class="mb-0" id="faq4-content">Debido al cambio climático ya no existe
                                    estacionalidad, por lo tanto es recomendable que lleve collar antiparasitario todo
                                    el año o cualquier presentación de antiparasitario externo, es decir, pipetas,
                                    sprays …</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-6">
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-3" href="#!"
                        onmouseover="showParagraph(this)">
                        <div class="caption">
                            <div class="caption-content text-white">
                                <div class="h2" id="faq5-title">¿Mi perr@ o mi gat@ tendrán problemas de
                                    comportamiento si no los esterilizo?</div>
                                <p class="mb-0" id="faq5-content">Problemas de comportamiento En el caso de las
                                    gatas, los momentos del celo pueden pasar inadvertidos o convertirse en una tortura
                                    de ruidos para usted y sus vecinos así como problemas de estrés para la gata. Algo
                                    semejante sucede en los gatos macho, donde su principal problema suele ser el
                                    marcaje urinario por distintas zonas de la casa. Las perras en celo deben ser
                                    sacadas durante su periodo de ovulación siempre atadas ya que, además de que las
                                    pueden montar, suelen tener más tendencia a escaparse. Las secreciones vulvares
                                    pueden ser incómodas. Algunas de ellas si sufren embarazo psicológico tienen
                                    problemas de comportamiento y algunas secreción de leche por las mamas. Los perros
                                    macho son más escapistas cuando las hembras están en celo, haciéndose casi imposible
                                    que respondan a nuestra llamada en esos momentos. Los problemas de agresividad entre
                                    muchos se ven reducidos con la castración y generalmente desaparecen, esto depende
                                    entre otras cosas de la edad del perro en el momento de la cirugía.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a class="portfolio-item bg-gradient-primary-to-secondary rounded p-4" href="#!"
                        ...
                        <div class="caption">
                            <div class="caption-content text-white ">
                                <div class="h2 text-white" id="faq6-title">Si mi perro tiene sarro en los dientes,
                                    ¿qué debería de hacer? </div>
                                <p class="mb-0" id="faq6-content">El sarro está pegado al diente y aparece como
                                    consecuencia de no haber eliminado la placa bacteriana inicial. Dicho sarro se va
                                    acumulando y va provocando una retracción de la encía hasta llegar incluso a
                                    provocar la caída de la pieza dental. Para quitar totalmente la placa de sarro se
                                    tiene que realizar una limpieza dental mediante ultrasonidos. Estas limpiezas las
                                    realizamos en Zarpa previa sedación de la mascota. Primero quitamos la placa de
                                    sarro con ultrasonidos, después eliminamos la placa bacteriana entre el diente y la
                                    encía y finalmente pulimos los dientes para reparar los daños en el esmalte dental.
                                    Después de hacer la limpieza dental, continuamos con las medidas preventivas para
                                    evitar o retrasar en lo posible el acumulo de nueva placa bacteriana.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="text-center mb-5">
                    <div class="d-flex justify-content-center text-center">
                        <img class="profile-img"
                            src="images/pikaso_reimagine_digital-painting-A-chubby-gray-cat-with-a-cute-fri__1_-removebg-preview.png"
                            alt="..." width="15%" />
                    </div>
                    <h1 class="fw-bolder" id="main-titlee">¿Qué le ocurre a tu mascota?</h1>
                    <p class="lead fw-normal text-muted mb-0"id="titlee">Si tienes alguna duda puedes ponerte en
                        contacto con nuestros especialistas</p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        ...
                        <form action="{{ route('guardar-consulta') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="nombre"
                                    class="block text-gray-700 text-white font-bold mb-2"id="nombre">Nombre de tu
                                    mascota:</label>
                                <input type="text" name="nombre" id="nombre"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:text-gray-300"
                                    required>
                                @error('nombre')
                            ...
                            <div class="mb-4">
                                <label for="especie"
                                    class="block text-gray-700 text-white font-bold mb-2"id="especie">Especie:</label>
                            ...
                            <div class="mb-4">
                                <label for="edad"
                                    id="edad"class="block text-gray-700 text-white font-bold mb-2">Edad:</label>
                            ...
                            <div class="mb-4">
                                <label for="sintomas"
                                    id="sintomas"class="block text-gray-700 text-white font-bold mb-2">Síntomas:</label>
                            ...
                            <div class="mb-4">
                                <label for="imagen" class="block text-gray-700 text-white font-bold mb-2"
                                    id="imagen">Subir imagen:</label>
                            ...
                            <div class="mb-4">
                                <label for="comentarios"
                                    id="comentarios"class="block text-gray-700 text-white font-bold mb-2">Comentarios
                                    adicionales:</label>
                                <textarea name="comentarios" id="comentarios"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:text-gray-300"></textarea>
                                @error('comentarios')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="flex items-center justify-between">
                                <button type="submit"
                                    class="bg-gradient-primary-to-secondary text-white text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-gray-900 dark:bg-black dark:text-gray-300 dark:hover:bg-gray-800"id="ask-question">Enviar
                                    consulta</button>
                            </div>
                        </form>
