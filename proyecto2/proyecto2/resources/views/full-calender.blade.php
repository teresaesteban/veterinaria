                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase" id="header-badge">CALENDARIO</div>
                        </div>
                        <div class="fs-3 fw-light text-muted" id="instruction-text">Tu calendario facíl de usar</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-white d-inline"
                                id="welcome-text">Concerta citas y consulta eventos</span></h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn bg-gradient-primary-to-secondary text-white btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="#ir" id="create-appointment">Crea Cita</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-4 mb-5">
                        <div class="text-center">
                            ...
                            <p class="text-white mb-0" id="add-appointment-text">Haz clic en el calendario para
                                seleccionar un rango de fechas y añadir una nueva cita.</p>
                        </div>
                    </div>
                    <!-- Editar citas -->
                    <div class="col-lg-4 col-md-4 mb-5">
                        <div class="text-center">
                            ...
                            <p class="text-white mb-0" id="edit-appointment-text">Puedes arrastrar y soltar las citas
                                para cambiar su fecha y hora.</p>
                        </div>
                    </div>
                    <!-- Borrar citas -->
                    <div class="col-lg-4 col-md-4 mb-5">
                        <div class="text-center">
                            ...
                            <p class="text-white mb-0" id="delete-appointment-text">Haz clic en una cita para eliminarla
                                del calendario.</p>
                        </div>
                    </div>
                </div>
                        ...
                        if (title) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    true); // Renderiza el nuevo evento en el calendario
