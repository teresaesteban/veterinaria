                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="mb-7 mb-lg-0 text-center text-lg-start">
                            ...
                            <div class="fs-3 fw-light text-muted" id="clinic-description">Cuidando de tus mascotas como
                                si fueran de la familia</div><br>
                            <a href="#section2" class="btn bg-gradient-primary-to-secondary text-white"
                                id="learn-more">Saber más</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="masthead-device-mockup position-relative">
                            <!-- SVG del círculo de fondo -->
                            <svg class="circle position-absolute" viewBox="0 0 100 100"
        ...
        <aside class="text-center bg-gradient-primary-to-secondary">
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        <div class="h2 fs-1 text-white mb-4"id="clinic-sencilla">"Una forma sencilla de gestionar las
                            visitas y cuidar de tus compañeros peludos, ¡todo en una sola aplicación!"</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-5"> <!-- Cambié col-md-6 por col-lg-4 -->
                        ...
                        <x-nav-link :href="url('full-calender')" :active="request()->routeIs('full-calender')">
                            <div class="text-center">
                                ...
                                <p class=" mb-0 text-white fs-5" id="calendar-description">Organiza citas y
                                    recordatorios importantes para tu mascota.</p>
                            </div>
                        </x-nav-link>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-5"> <!-- Cambié col-md-6 por col-lg-4 -->
                        ...
                        <x-nav-link :href="route('usuarios.search')" :active="request()->routeIs('usuarios.search')">
                            <div class="text-center">
                                ...
                                <p class=" mb-0 text-white fs-5" id="medical-description">Mantén un registro detallado
                                    de las visitas al veterinario, tratamientos y más.</p>
                            </div>
                        </x-nav-link>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-5"> <!-- Cambié col-md-6 por col-lg-4 -->
                        ...
                        <x-nav-link :href="url('quelepasa')" :active="request()->routeIs('quelepasa')">
                            <div class="text-center">
                                ...
                                <p class=" mb-0 text-white fs-5" id="question-description">Pregunta a nuestros
                                    especialistas cualquier duda que te pueda surgir en el cuidado de tu mascota</p>
                            </div>
                        </x-nav-link>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-5"> <!-- Cambié col-md-6 por col-lg-4 -->
                        ...
                        <x-nav-link :href="url('home')" :active="request()->routeIs('home')">
                            <div class="text-center ">
                                ...
                                <p class="text-white mb-0 fs-5" id="about-description">En la página principal podrás
                                    encontrar la información general de su funcionamiento</p>
                            </div>
                        </x-nav-link>
                    </div>
                </div>
                    ...
                    <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                        <div class="col-sm-8 col-md-6">
                            <div class="px-5 px-sm-0">
                                <img class="img-fluid" src="images/foto1.png" alt="Imagen Sobre Nosotros"
                                    width="70%" />
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            ...
                            <p class="text-white mb-5 fs-5" id="about-text">
                                En VetClinic, nos esforzamos por brindar un entorno amigable y eficiente para que los
                                veterinarios puedan registrar y acceder fácilmente a la información de los pacientes,
                                administrar citas, llevar un historial clínico completo, y proporcionar un seguimiento
                                más preciso y personalizado del estado de salud de las mascotas.
                            </p>
                            <p class="text-white mb-5 fs-5" id="about-text2">
                                Con VetClinic, esperamos contribuir al bienestar y cuidado de todas las mascotas,
                                ofreciendo a los profesionales veterinarios las herramientas necesarias para un servicio
                                de calidad y a los dueños de mascotas la tranquilidad de contar con un equipo
                                comprometido con la salud y felicidad de sus compañeros peludos.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        ...
                        <form class="form-subscribe" id="contactFormFooter" method="POST"
                            ...
                            <div class="row">
                                <div class="col">
                                    <input class="form-control form-control-lg" name="email" id="emailAddressBelow"
                                        type="email" placeholder="Correo electrónico" required />
                                </div>
                                <div class="col-auto"><button
                                        class="btn bg-gradient-primary-to-secondary text-white btn-lg" type="submit"
                                        id="send-button">Enviar</button></div>
                            </div>
                            ...
                            <div class="d-none" id="submitErrorMessage">
                                <div class="text-center text-danger mb-3">¡Error al enviar el correo electrónico!</div>
                            </div>
                        </form>
                    </div>
                </div>
