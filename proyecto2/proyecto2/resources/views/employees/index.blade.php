    ...
    <body>
        <header class="py-5">
            <div class="container px-5 pb-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="fs-3 fw-light text-muted" id="instruction-text">Para crear una nueva empleado, introduce
                        sus datos. Para ver los empleados mira al fondo de la página</div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-white d-inline" id="welcome-text">Bienvenido
                            al gestor de empleados</span></h1>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-4">
            <form action="{{ route('employees.create') }}" method="POST" class="row g-3">
                @csrf
                <div class="col-md-4">
                    <input type="text" name="name" class="form-control" id="name-placeholder" placeholder="Nombre"
                        required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    <button type="submit" class="btn bg-gradient-primary-to-secondary text-white"
                        id="create-employee-btn">Crear Empleado</button>
                </div>
            </form>
        </div>
        <br>
